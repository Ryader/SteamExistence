...
public class AchievementSystem : MonoBehaviour
{
    ...
    [Header("Шаблоны:")]
    [SerializeField] private AchievementComponent messageSample; 
    [SerializeField] private AchievementListComponent listSample; 
    [Header("Настройки:")]
#if UNITY_EDITOR
    [SerializeField] private float offset = 10; 
#endif
    [SerializeField] private RectTransform listTransform;
    [SerializeField] private AchievementListComponent[] list;
